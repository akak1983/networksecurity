...
from networksecurity.utils.main_utils.utils import save_numpy_aray_data, save_object
...
class DataTransformation:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            save_numpy_aray_data(self.data_transformation_config.transformed_train_file_path, array=train_arr,)
            save_numpy_aray_data(self.data_transformation_config.transformed_test_file_path, array=test_arr,)
